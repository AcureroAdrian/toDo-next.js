...
const NewTask = () => {
  ...
  const createTask = async () => {
      try {
        await fetch('https://to-do-next-js-theta.vercel.app/api/tasks', {
          method: 'POST',
          headers: {
  ...
  const getTask = async () => {
    const data = await fetch(`https://to-do-next-js-theta.vercel.app/api/tasks/${query.id}`).then(res => res.json())
